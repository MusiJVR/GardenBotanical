...
public class DyeMixerSyncPacket {
    ...
    public static PacketByteBuf write(DefaultedList<ItemStack> inventory, SingleVariantStorage<FluidVariant> fluidStorage, BlockPos blockPos) {
